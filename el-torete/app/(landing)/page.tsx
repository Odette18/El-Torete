      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-secondary text-black hover:bg-secondary/90 font-bold">
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-white text-white hover:bg-white hover:text-black bg-transparent font-bold"
            >
      ...
      <section className="py-16 bg-[#1F2937] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              <Beef className="h-12 w-12 text-secondary mb-4" />
              <h3 className="text-3xl font-bold">{featuredItems?.length || 25}+</h3>
              <p className="text-gray-300">Variedades de Hamburguesas</p>
            </div>
            <div className="flex flex-col items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <CardContent className="p-6 bg-secondary/5">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Button className="bg-primary hover:bg-primary/90">Ordenar</Button>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="text-center mt-12">
            <Button asChild size="lg" className="bg-primary hover:bg-primary/90">
              <Link href="/landing/menu">Ver Menú Completo</Link>
            </Button>
          </div>
        </div>
      </section>
          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg mb-8">
                Nuestro equipo está formado por apasionados de la gastronomía que trabajan día a día para ofrecerte la
                mejor experiencia culinaria. Cada hamburguesa es preparada con amor y dedicación, manteniendo siempre
